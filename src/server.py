...
from .http.routes.get_day_orders_amount import day_order_blp
...
from .http.routes.get_daily_receipt_in_period import daily_receipt_blp
...
def setup_app(app: Flask) -> None:
    ...
    api.register_blueprint(day_order_blp)
    ...
    api.register_blueprint(daily_receipt_blp)
