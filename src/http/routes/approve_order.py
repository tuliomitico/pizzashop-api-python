...
approve_order_blp = Blueprint("approve_order", "orders", url_prefix="/orders", description="Operations on order")

@approve_order_blp.route("/<order_id>/approve",methods=['PATCH'])
