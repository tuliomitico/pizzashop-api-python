...
deliver_order_blp = Blueprint("deliver_order", "orders", url_prefix="/orders", description="Operations on order")

@deliver_order_blp.route("/<order_id>/deliver",methods=['PATCH'])
