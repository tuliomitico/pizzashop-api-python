...
from src.db.connection import db_session, init_db, engine
from src.db.schema import User, Restaurants, Products, OrderItems, Orders
...
if db_session.query(exists().where(User.id.isnot(None))).scalar() and \
db_session.query(exists().where(Restaurants.id.isnot(None))).scalar() and \
db_session.query(exists().where(Products.id.isnot(None))).scalar() and \
db_session.query(exists().where(OrderItems.id.isnot(None))).scalar() and \
db_session.query(exists().where(Orders.id.isnot(None))).scalar():
  db_session.query(Orders).delete()
  db_session.query(Products).delete()
  db_session.query(Restaurants).delete()
  db_session.query(OrderItems).delete()
